...
<h2 id="rrg">Sector and Theme RRG</h2><div class="table-wrap"><table><thead><tr>${sectorFields.map(([label]) => `<th>${label}</th>`).join("")}</tr></thead><tbody>${rowsHtml(result.sector_rrg, sectorFields)}</tbody></table></div>
