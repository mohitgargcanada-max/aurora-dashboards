...
export function buildDashboardModel({ rows, rejected, indexAudit, coverage, expectedSession, scanMode = "SUNDAY_FULL_REBUILD", previousWeeklyContract = null, generatedAt = new Date().toISOString(), benchmarkRecord = null }) {
  ...
  return { expectedSession, rows, rejected, indexAudit, coverage, marketConfirmation, weeklyUniverse, weeklyFocus, dailyTop, rsleTop20, developing, nearRsHigh, myhApproachingRows, ma10Respect, ma21Respect, ma50Respect, pullbacks, basepivots, rmvp, ve2, compression, noChase, themes, weeklyContract: weeklyPlan.weeklyContract, cadenceWarnings: weeklyPlan.warnings, discovery };
}
