...
assert.equal(resolveEodhdToken({ AURORAKEYS: JSON.stringify({ AURORA_KEYS: "SEC_USER_AGENT=agent\nEODHD_API_TOKEN=token-p\n" }) }), "token-p");
assert.equal(resolveEodhdToken({ AURORAKEYS: "EODHD_API_TOKEN token-q\n" }), "token-q");
